    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <nav className="w-full px-6 py-4 flex justify-between items-center">
        <div className="flex items-center gap-8">
          ...
          <div className="flex gap-6 text-sm">
            ...
            <a href="#" className="text-gray-800 hover:text-gray-600">Documentation</a>
          </div>
        </div>
      ...
      <main className="flex-grow flex flex-col items-center px-4 py-16 max-w-4xl mx-auto justify-center">
        ...
        <p className="text-xl text-gray-600 mb-8 text-center max-w-2xl">
          A peer-to-peer distributed system for executing serverless functions and deploying tasks efficiently using Tauri + Next.js
        </p>

        <div className="flex gap-4 mb-12 flex-col justify-center items-center">
          <a href="/download" className="bg-black text-white px-6 py-3 rounded-full font-medium hover:bg-gray-800 transition flex items-center justify-center gap-2">
          ...
          <h2 className="text-sm text-gray-500 md:max-w-[70%] text-center ">Available for macOS, Linux, and Windows</h2>
        </div>
